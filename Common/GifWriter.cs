...
// Blatantly stolen from  https://stackoverflow.com/questions/1196322/how-to-create-an-animated-gif-in-net
...
namespace Common
{
	public interface IGifWriter : IDisposable
	{
		/// <summary>
		/// Adds a frame to this animation.
		/// </summary>
		/// <param name="Image">The image to add</param>
		/// <param name="Delay">Delay in Milliseconds between this and last frame... 0 = <see cref="GifWriter.DefaultFrameDelay"/></param>
	...
	/// </summary>
	public class GifWriter : IDisposable, IGifWriter
	{
		#region Fields
		...
		public GifWriter(string FileName, int DefaultFrameDelay = 500, int Repeat = -1)
			: this(new FileStream(FileName, FileMode.OpenOrCreate, FileAccess.Write, FileShare.Read), DefaultFrameDelay,
				Repeat)
		{
		}
		...
		static void WriteImageBlock(Stream SourceGif, BinaryWriter Writer, bool IncludeColorTable, int X, int Y, int Width,
			int Height)
		{
	...
	public class NullWriter : IGifWriter
	{
		public void Dispose()
		{
			return;
